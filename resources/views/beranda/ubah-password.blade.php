    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                @endif
                <form class="form-horizontal" method="POST" action="{{ url('ubah-password') }}">
                {{ csrf_field() }}
                ...
                <div class="col-md-6">
                <input id="new-password" type="password" placeholder="Masukan paswword baru" class="form-control" name="new-password" required>
